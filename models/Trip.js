...
const tripSchema = new Schema({ 
    start: { type: String, required: true, minlength: [4, 'Starting Point and End Point should be at least 4 characters long'] },
    ...
    brand: { type: String, required: true, minlength: [3, 'Car Brand should be at least 3 characters long'] },
